...
namespace PluginMaster
{
    ...
    {
        #region BLOCK BOX DELETE PREVIEW
        private static bool PreviewBlockBoxDelete(Camera camera, out Vector3 mousePos3D,
        ...
        #region BLOCK BOX DELETE INPUT
        private static void DeleteBlockBoxInput(Vector3 mousePos3D)
        {
