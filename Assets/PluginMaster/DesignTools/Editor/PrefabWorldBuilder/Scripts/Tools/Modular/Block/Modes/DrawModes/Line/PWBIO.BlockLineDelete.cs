...
namespace PluginMaster
{
    ...
    {
        #region BLOCK LINE DELETE PREVIEW
        private static bool PreviewBlockLineDelete(Camera camera, out Vector3 mousePos3D,
        ...
        #endregion
        #region BLOCK LINE DELETE INPUT
        private static void DeleteBlockLineInput(Vector3 mousePos3D)
        {
            ...
            {
                if (_blockDeleteTargets != null && _blockDeleteTargets.Count > 0)
                {
